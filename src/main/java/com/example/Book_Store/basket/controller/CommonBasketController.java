...
public class CommonBasketController {
    ...
    public CommonBasketController(BasketServiceImpl basketService) {
    ...
    public ResponseEntity<String> updateBasket(@PathVariable Long id, @PathVariable Long quantity, Principal principal) {
