package com.example.Book_Store.store.basket.controller;
...
public class CommonBasketController {
    ...
    public ResponseEntity<String> addBookToBasket(@PathVariable Long idBook, @PathVariable Long quantity,
                                                  Principal principal) {
    ...
    public ResponseEntity<String> updateQuantityBookInBasket(@PathVariable Long id, @PathVariable Long quantity,
                                                             Principal principal) {
